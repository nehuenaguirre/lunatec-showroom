  ...
  return (
    <footer className="bg-white border-t border-gray-100 mt-auto font-sans">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        ...
        {/* Grilla principal: 3 columnas bien distribuidas */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          {/* COLUMNA 3: CONTACTO (WhatsApp e Instagram Manuales) */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h4 className="font-display font-black text-gray-900 uppercase tracking-tighter mb-8 text-lg">
              Contacto
            </h4>
            <div className="flex flex-col gap-5 w-full items-center md:items-start">
              ...
              {/* WhatsApp - SVG MANUAL */}
              <a href="https://wa.me/5493815135998" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.instagram.com/lunatec.tuc/" target="_blank" rel="noopener noreferrer" 
