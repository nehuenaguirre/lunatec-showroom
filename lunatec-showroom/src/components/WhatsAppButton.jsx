...
export default function WhatsAppButton({ numero, mensaje }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-[#25D366] hover:bg-[#1DA851] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 z-50 flex items-center justify-center group"
